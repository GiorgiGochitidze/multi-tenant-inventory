...
export class InitialMigration1784918606962 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_e8d476ecf0dc3a729dc187e014" ON "products"  ("tenantId", "sku") WHERE "deletedAt" IS NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "orderId" uuid NOT NULL, "productId" uuid NOT NULL, "quantity" integer NOT NULL, "unitPrice" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_a927d20aab3b21a564b0d00fd6" ON "orders"  ("tenantId", "orderNumber") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_208a358e9fe8abe6e1d82459804" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a927d20aab3b21a564b0d00fd6"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e8d476ecf0dc3a729dc187e014"`,
    );
